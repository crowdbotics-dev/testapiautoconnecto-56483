...
## Project Structure
    ...
    ├── testapiautoconnecto_56483  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_56483`
...
2. Clone this repo and `cd testapiautoconnecto_56483`
